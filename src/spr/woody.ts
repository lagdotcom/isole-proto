		...
		animations: {
			...
			[aWalk]: {
				...
				frames: [
					...
					{ c: 2, r: 1, t: 60 },
					{ c: 2, r: 2, t: 60 },
					{ c: 2, r: 3, t: 60, event: 'onstep' },
					{ c: 2, r: 4, t: 60 },
					{ c: 2, r: 5, t: 60 },
					{ c: 2, r: 6, t: 60 },
					{ c: 2, r: 7, t: 60 },
					{ c: 2, r: 8, t: 60 },
					{ c: 2, r: 9, t: 60, event: 'onstep' },
					{ c: 2, r: 10, t: 60 },
					{ c: 2, r: 11, t: 60 },
				],
			},
			...
			[aAxe]: {
				...
				flags: { noAttack: true, noTurn: true },
				frames: [
					{ c: 8, r: 0, t: 50, hotspot: { x: -100, y: 90 } },
					{ c: 8, r: 1, t: 50, hotspot: { x: -100, y: 90 } },
					{ c: 8, r: 2, t: 50, hotspot: { x: -100, y: 90 } },
					{ c: 8, r: 3, t: 50, hotspot: { x: -100, y: 90 } },
					{ c: 8, r: 4, t: 50, hotspot: { x: -100, y: 90 } },
					{
						c: 8,
						r: 5,
						t: 50,
					...
					{ c: 8, r: 6, t: 50, hotspot: attackHotspot },
					{ c: 8, r: 7, t: 50, hotspot: attackHotspot },
					{ c: 8, r: 8, t: 50, hotspot: attackHotspot },
					{ c: 8, r: 9, t: 150, hotspot: attackHotspot },
				],
			},
